  ...
  const storyScenes = [
    {
      ...
      content:
        "On the vast plains of Kurukshetra, two armies stand ready for the greatest battle in history. But this is more than a war of weapons—it's a battle for the soul of dharma itself.",
    ...
    },
    {
      ...
      content:
        "Arjuna, the greatest archer, sees his beloved teachers and family on the opposing side. His bow slips from his hands as confusion clouds his warrior spirit. Sound familiar?",
    ...
    },
    {
      ...
      content:
        "Krishna, no ordinary charioteer, reveals himself as the eternal teacher. His words don't just guide Arjuna through battle—they illuminate the path for every soul seeking purpose.",
    ...
    },
    {
      ...
      content:
        "In 700 verses, Krishna addresses every human struggle: doubt, purpose, love, duty, fear, and transcendence. The Bhagavad Gita becomes humanity's spiritual GPS.",
    ...
    },
    {
      ...
      content:
        "Just like Arjuna, you face daily battles—career choices, relationships, purpose, inner peace. The same confusion that gripped him on that ancient battlefield echoes in your heart today.",
    ...
    },
    {
      ...
      content:
        "Imagine having Krishna as your personal guide, available 24/7 to answer your deepest questions. Through AI, his timeless wisdom becomes your modern-day spiritual companion.",
            ...
            {storyScenes.map((scene, index) => (
              ...
              >
                <div className="mb-8">
                  ...
                  <p className="text-divine-gold text-lg mb-3">
                    {scene.subtitle}
                  </p>
                  <p className="text-divine-lavender/80 leading-relaxed">
                    {scene.content}
                  </p>
                </div>
              </div>
